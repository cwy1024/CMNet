...
# 2020
IMG_PATH = glob(r"D:\dataset\brats2020\160_224_240\224\trainimage\*")
MASK_PATH = glob(r"D:\dataset\brats2020\160_224_240\224\trainmask\*")


# 2021
# IMG_PATH = glob(r"D:\dataset\brats2021\archive\160_224_240\224\trainimage\*")
# MASK_PATH = glob(r"D:\dataset\brats2021\archive\160_224_240\224\trainmask\*")
...
def train(args, train_loader, model, criterion, optimizer, epoch, scheduler=None):
    ...
    for i, (input, target) in tqdm(enumerate(train_loader), total=len(train_loader)):
        ...
        # compute output
        if args.name == 'a':
            output1, output2, output3, output = model(input)
            loss1 = criterion(output1, target)
            loss2 = criterion(output2, target)
            loss3 = criterion(output3, target)
            loss4 = criterion(output, target)
            # loss=weight(loss1, loss2, loss3, loss4)
            loss = 0.2 * loss1 + 0.4 * loss2 + 0.6 * loss3 + loss4
...
def main():
    ...
    for epoch in range(args.epochs):
        ...
        # train for one epoch
        # train_log = train(args, train_loader, model, criterion, loss_weight,optimizer, epoch)
        train_log = train(args, train_loader, model, criterion, optimizer, epoch)
        # evaluate on validation set
        # val_log = validate(args, val_loader, model, criterion,loss_weight)
